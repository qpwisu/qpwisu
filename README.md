...
| [신한투자증권] 프로 디지털 아카데미 수료 [우수 수료생 선정]                   | 24.09.03 ~  25.03.18               |
| [신한투자증권] 정보시스템부 인턴                  | 2025.04.14 ~  2025.05.21              |


### 🥇수상🥇
| **상훈명** | **수여기관** | **수상일자** | **수상내역** |
| --- | --- | --- | --- |
| World Robot Olympiad 정규종목 고등부문 Inspire Award(1등) | 인천광역시장상 | 2015.08.16 | 로봇을 활용해 다양한 미션을 수행하고 특정 문제를 해결하는 대회 |
| 다학제간캡스톤디자인 경진대회 장려상 | 국민대학교 | 2023.06.02 | 국내 주식 관련주 검색 어플리케이션 개발 |
| 신한투자증권 프로 디지털 아카데미 중간 프로젝트 발표회 우수팀(1등) | 일파코, 신한투자증권 | 2024.12.06 | ChatGPT API로 기업 공시를 요약, 분석하는 웹사이트 개발 |
| 신한투자증권 프로 디지털 아카데미 최종 프로젝트 최우수상(1등) | 일파코, 신한투자증권 | 2025.03.18 | 손쉬운 시각화 조건 검색 웹 서비스 Snowper (MSA, Cloud) |
...
- [![Tistory Badge](https://img.shields.io/badge/Tistory-000000?style=flat&logo=tistory&logoColor=white)](https://jhycoding.tistory.com/)
